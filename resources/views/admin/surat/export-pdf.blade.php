...
<head>
    <meta charset="utf-8" />
    <title>Surat Keterangan - {{ $surat->id }}</title>
    <style>
        @page {
            margin: 20px 30px;
            size: A4;
...
<body>
    <div class="header">
        <div class="logo">
            <img src="{{ public_path('assets/images/my/sidoarjo.png') }}" alt="logo" style="width:100%;" />
        </div>
        <div class="gov">
            ...
            <p>Telp. (031) 8671234, Email: kelmedaeng@gmail.com</p>
        </div>
    </div>
    ...
    <div class="nomor">Nomor : <strong>{{ $surat->nomor ?? '474/001/Kel.Med/Waru/' . date('Y') }}</strong></div>
    ...
    <div class="signature" style="position:relative;">
        ...
        @if(!empty($signature_qr))
            <div style="float:right; text-align:center; margin-top:8px; max-width:120px;">
                <img src="{{ $signature_qr }}" alt="QR Signature" style="width:100px; border:1px solid #000; padding:3px; background:#fff; display:block;" />
                <div style="font-size:8px; margin-top:3px;">Tanda tangan digital</div>
            </div>
