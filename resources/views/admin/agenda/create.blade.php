    ...
    <div class="card border-0 shadow-sm rounded-4">
        <div class="card-header bg-white border-0" style="border-bottom: 2px solid #e5e7eb;">
            <div class="d-flex align-items-center">
                <i class="ti ti-plus me-2" style="font-size: 1.5rem; color: #f59e0b;"></i>
                <h5 class="mb-0 fw-bold">Buat Agenda Baru</h5>
            </div>
            <p class="text-muted small mt-2 mb-0">Tambahkan agenda kegiatan desa baru</p>
        </div>
            ...
            <form method="POST" action="{{ route('admin.agenda.store') }}" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-lg-8">
                        ...
                        <div class="form-group mb-4">
                            ...
                            <input type="text" name="title" class="form-control form-control-lg @error('title') is-invalid @enderror" 
                                placeholder="Contoh: Festival Budaya Desa" value="{{ old('title') }}" required>
                            @error('title')
                        ...
                        <div class="form-group mb-4">
                            ...
                            <textarea name="description" rows="6" 
                                ...
                                placeholder="Jelaskan detail agenda kegiatan..." required>{{ old('description') }}</textarea>
                            @error('description')
                                <small class="text-danger d-block mt-1">{{ $message }}</small>
                            @enderror
                        </div>
                        ...
                        <div class="form-group mb-4">
                            ...
                            <input type="text" name="location" class="form-control form-control-lg @error('location') is-invalid @enderror" 
                                placeholder="Contoh: Lapangan Desa" value="{{ old('location') }}" required>
                            @error('location')
                                <small class="text-danger d-block mt-1">{{ $message }}</small>
                            @enderror
                        </div>
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="alert alert-info">
                            <strong><i class="ti ti-info-circle me-2"></i>Tips:</strong>
                            <ul class="mb-0 mt-2" style="font-size: 0.9rem;">
                                <li>Gunakan gambar yang menarik</li>
                                <li>Resolusi minimal 800x600px</li>
                                <li>Status otomatis update setiap jam</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="d-flex gap-2 justify-content-between mt-4">
                    ...
                    <button type="submit" class="btn btn-primary btn-lg">
                        <i class="ti ti-plus me-2"></i>Buat Agenda
                    </button>
                </div>
            </form>
        </div>
