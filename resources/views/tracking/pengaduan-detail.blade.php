...
<div class="pc-content">
            ...
            <div class="row align-items-center">
                <div class="col-md-12">
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Tracking Pengaduan</li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="row">
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <h5 class="mb-0"><i class="ti ti-timeline me-2"></i>Timeline Pengaduan</h5>
                        <span class="badge bg-{{ $pengaduan->status_badge }} fs-6">{{ $pengaduan->status_label }}</span>
                    </div>
                </div>
                <div class="card-body">
        ...
        <div class="col-lg-4 col-md-12">
            ...
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0"><i class="ti ti-info-circle me-2"></i>Detail Pengaduan</h5>
                </div>
                <div class="card-body">
                    <div class="mb-3">
                        <p class="text-muted small mb-1">Nomor Pengaduan</p>
                        <p class="fw-bold">{{ $pengaduan->nomor_pengaduan }}</p>
                    </div>

                    <div class="mb-3">
                        <p class="text-muted small mb-1">Judul</p>
                        <p class="fw-bold">{{ $pengaduan->judul_pengaduan }}</p>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <span class="badge bg-{{ $pengaduan->status_badge }} fs-6 w-100 text-center py-2">
                    ...
                    <div class="mb-3">
                        ...
                        <p class="fw-bold">{{ $pengaduan->created_at->format('d M Y H:i') }}</p>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <p class="fw-bold">
                            @php
                                $latest = $pengaduan->latestTracking();
                            @endphp
                            {{ $latest ? $latest->created_at->format('d M Y H:i') : 'Belum ada' }}
                        </p>
                    </div>

                    @if($pengaduan->latestTracking() && $pengaduan->latestTracking()->notes)
                        <hr>
                        <div>
                            <p class="text-muted small mb-1">Catatan Terakhir</p>
                            <p class="text-sm">{{ $pengaduan->latestTracking()->notes }}</p>
                        </div>
                    @endif
                    ...
                    @if($pengaduan->admin)
                        <hr>
                        <div>
                            <p class="text-muted small mb-1">Admin Penangani</p>
                            <p class="fw-bold">{{ $pengaduan->admin->name }}</p>
                        </div>
                    @endif
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-grid gap-2">
                        <a href="{{ route('user.pengaduan.show', $pengaduan->id) }}" class="btn btn-outline-primary">
                            <i class="ti ti-eye me-1"></i>Lihat Detail Pengaduan
                        </a>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        fetch(`/api/tracking/pengaduan/${pengaduanId}`)
