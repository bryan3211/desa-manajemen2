<!-- User Sidebar Items -->
<li class="pc-item {{ request()->is('biodata*') ? 'active' : '' }}">
    <a href="{{ route('user.biodata.index') }}" class="pc-link">
...
<li class="pc-item {{ request()->is('pengaduan*') ? 'active' : '' }}">
    <a href="{{ route('user.pengaduan.index') }}" class="pc-link">
        ...
        <span class="pc-mtext">Lapor Aduan</span>
    </a>
</li>

<li class="pc-item {{ request()->is('tracking*') ? 'active' : '' }}">
    <a href="{{ route('user.tracking.index') }}" class="pc-link">
        <span class="pc-micon"><i class="ti ti-track"></i></span>
        <span class="pc-mtext">Pelacakan Status</span>
    </a>
</li>

<li class="pc-item {{ request()->is('agenda*') ? 'active' : '' }}">
    <a href="{{ route('user.agenda.index') }}" class="pc-link">
        <span class="pc-micon"><i class="ti ti-calendar-event"></i></span>
        <span class="pc-mtext">Agenda Desa</span>
    </a>
</li>

<li class="pc-item {{ request()->is('ulasan*') ? 'active' : '' }}">
    <a href="{{ route('user.ulasan.index') }}" class="pc-link">
